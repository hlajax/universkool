...
class DemandesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create demande" do
    assert_difference('Demande.count') do
      post demandes_url, params: { demande: { contenu: @demande.contenu, email: @demande.email, nom: @demande.nom, objet: @demande.objet, telephone: @demande.telephone } }
    end
  ...
  test "should update demande" do
    patch demande_url(@demande), params: { demande: { contenu: @demande.contenu, email: @demande.email, nom: @demande.nom, objet: @demande.objet, telephone: @demande.telephone } }
